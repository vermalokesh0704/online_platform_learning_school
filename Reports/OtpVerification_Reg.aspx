<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_login_signup.master" AutoEventWireup="true" CodeFile="OtpVerification_Reg.aspx.cs" Inherits="Reports_OtpVerification_Reg" %>
                    ...
                    <div class="col-md-2 col-md-offset-1">
                        <div class="login-box-left  white-bg">
                            ...
                            <ul class="nav">
                                ...
                                <li class="active"><a href="OtpVerification_Reg.aspx"><i class="ti-pencil-alt"></i>OTP Verification</a></li>
                    ...
                    <div class="col-md-4 theme-bg">
                        <div class="login-box pos-r text-white login-box-theme">
                            ...
                            <div class="form-group" style="padding-top: 10px; color: black;">
                                <span style="color: black;">Note: Please Enter OTP which is sent to the mobile no. which is provided by you at the time of registration   </span>
                            </div>
